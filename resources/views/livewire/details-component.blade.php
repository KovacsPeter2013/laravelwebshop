                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <div class="stock-info in-stock">
                            <p class="availability">Elérhetőség: <b>{{$product->stock_status}}</b></p>
                        </div>
                        ...
                        <div class="wrap-butons">
                            ...
                            <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}}, 
									'{{$product->name}}',
									{{$product->sale_price}})">Kosárba rakom</a>
                            @else
                            <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}}, 
									'{{$product->name}}',
									{{$product->regular_price}})">Kosárba rakom</a>

                            @endif

                            <div class="wrap-btn">
                                <a href="#" class="btn btn-compare">Összehasonlításra</a>
                                <a href="#" class="btn btn-wishlist">Kívánságlistára</a>
                            </div>
                        </div>
                    </div>
                    <div class="advance-info">
                        <div class="tab-control normal">
                            <a href="#description" class="tab-control-item active">Leírás</a>
                            <a href="#add_infomation" class="tab-control-item">További Információk</a>
                            <a href="#review" class="tab-control-item">Vélemények</a>
                        </div>
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    ...
                                    <div class="product-info">
                                        <a href="{{route('product.details',['slug'=>$p_product->slug])}}"
                                            title="{{$p_product->name}}"
                                            class="product-name"><span>{{$p_product->image}}</span></a>
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{route('product.details',['slug'=>$r_product->slug])}}"
                                        title="{{$p_product->name}}" title="{{$r_product->name}}">
                                    ...
                                    <div class="wrap-btn">
                                        <a href="#" class="function-link">Megnézem</a>
                                    </div>
                                </div>
                                <div class="product-info">
                                    <a href="{{route('product.details',['slug'=>$r_product->slug])}}"
