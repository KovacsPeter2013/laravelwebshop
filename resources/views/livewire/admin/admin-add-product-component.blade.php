                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{route('admin.products')}}" class="btn btn-success pull-right">Összes
                                    Termék</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="addProduct">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Termék neve" class="form-control input-md"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Termék slug" class="form-control input-md"
                                        wire:model="slug" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4" wire:ignore>
                                    ...
                                    <textarea class="form-control" placeholder="Rövid leírás"
                                        wire:model="short_description" id="short_description"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4" wire:ignore>
                                    ...
                                    <textarea class="form-control" placeholder="leírás" wire:model="description"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Darabszám" class="form-control input-md"
                                        wire:model="quantity" />
