					...
					<ul>
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								<h4 class="fc-name">Ingyenes kiszállítás</h4>
								<p class="fc-desc">Ingyenes kiszállítás 30 000 Ft. felett</p>
							</div>
						...
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								<h4 class="fc-name">Garancia</h4>
								<p class="fc-desc">30 napos visszafizetési garancia</p>
							</div>
						...
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								<h4 class="fc-name">BIZTONSÁGOS FIZETÉS</h4>
								<p class="fc-desc">Biztonságos online fizetés</p>
							</div>
						...
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								<h4 class="fc-name">Online Támogatás</h4>
								<p class="fc-desc">24 órás ügyfélszolgálat</p>
							</div>
			...
			<div class="main-footer-content">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							<div class="wrap-footer-item">
								<h3 class="item-header">Elérhetőség</h3>
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							...
							<div class="wrap-footer-item">
								<h3 class="item-header">Forró drót</h3>
								<div class="item-content">
							...
							<div class="wrap-footer-item footer-item-second">
								<h3 class="item-header">Iratkozz fel hírlevére</h3>
								<div class="item-content">
									<div class="wrap-newletter-footer">
										<form action="#" class="frm-newletter" id="frm-newletter">
											<input type="email" class="input-email" name="email" value="" placeholder="Email cím megadása">
											<button class="btn-submit">Feliratkozás</button>
										</form>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12 box-twin-content ">
							<div class="row">
								<div class="wrap-footer-item twin-item">
									<h3 class="item-header">Fiókom</h3>
									<div class="item-content">
										<div class="wrap-vertical-nav">
											<ul>
												<li class="menu-item"><a href="#" class="link-term">Fiókom</a></li>
								...
								<div class="wrap-footer-item twin-item">
									<h3 class="item-header">Információk</h3>
									<div class="item-content">
										<div class="wrap-vertical-nav">
											<ul>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							<div class="wrap-footer-item">
								<h3 class="item-header">Fizetési szolgáltatóink:</h3>
								<div class="item-content">
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							<div class="wrap-footer-item">
								<h3 class="item-header">Közösségi oldal elérhetőségeink</h3>
								<div class="item-content">
